...
<head>
    ...
    <style>
        ...
        .range-slider-container input[type=range] {{ 
            position: absolute; width: 100%; pointer-events: none; -webkit-appearance: none; z-index: 2; height: 6px; background: none; outline: none; margin: 0;
        }}
        ...
        .year-labels {{ display: flex; justify-content: space-between; font-size: 0.7rem; margin-top: 8px; opacity: 0.7; }}
...
<header>
    ...
    <div style="display: flex; align-items: center; gap: 20px;">
        ...
        <div style="text-align:right">
            <span style="font-size:0.8rem; opacity: 0.8; display: block;">Versión 3.14</span>
            <span style="font-size:0.65rem; opacity: 0.6;">Mar 2026</span>
        </div>
    </div>
</header>
...
<div class="main-container">
    ...
    <div class="sidebar">
        <!-- Nueva Sección de Narrativa - MOVIDA AL INICIO -->
        <div class="story-card">
            <h3>📖 Historia de Nuestra Tierra</h3>
            <div class="story-text">
                Colombia es un territorio dinámico donde convergen <b>cuatro placas tectónicas</b>: Nazca, Caribe, Cocos y Suramérica. 
                Esta interacción no solo crea montañas, sino fallas profundas que concentran la energía.
                <br><br>
                <b>¿Por qué más sismos en unos lugares?</b> Lugares como el <b>Nido de Bucaramanga</b> (Mesa de los Santos) concentran sismicidad por la fricción de placas a gran profundidad, mientras que las fallas corticales dispersan sismos superficiales en el eje andino.
            </div>
            
            <div class="fact-box">
                <span class="fact-title">💡 Dato Técnico (UNGRD)</span>
                El <b>87% de los colombianos</b> vive en zonas de amenaza alta o intermedia. No podemos predecirlos, pero sí entender sus patrones históricos.
            </div>
        </div>
        ...
        <div class="card">
            ...
            <p style="font-size:0.7rem; margin-top:10px; opacity:0.6; line-height:1.3">Filtra sismos por periodo histórico. Permite observar cómo ha evolucionado la actividad sísmica en el tiempo.</p>
        </div>
        ...
        <div class="card">
            ...
            <p style="font-size:0.7rem; margin-top:5px; opacity:0.6; line-height:1.3">Ajusta la cantidad de zonas (clústeres). Un K alto revela detalles locales específicos; un K bajo muestra tendencias regionales generales.</p>
        </div>
...
<script>
    ...
    function resetFilters() {{
        ...
        updateRange(); // Actualiza el label y track bilateral
